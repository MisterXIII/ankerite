...
public class OreConfigurations {
        ...
        public static final RegistryObject<ConfiguredFeature<?, ?>> ORE_ANKERITE_FEATURE = CONFIGURED_FEATURES.register("ore_ankerite", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(ANKERITE_REPLACEABLES.get(), 12)));
